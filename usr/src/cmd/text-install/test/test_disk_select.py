...
${WS}/proto/root_i386/usr/lib/python2.7/vendor-packages
3) pfexec python2.7 test_disk_select.py

A single test may be run by specifying the test as an argument to
step 3, e.g.:

pfexec python2.7 test_disk_select.py OnActivateTest.test_on_activate_default
